# 创建数据库，并创建权限用户
CREATE DATABASE `homer` CHARACTER SET utf8;
CREATE USER 'homer'@'%' IDENTIFIED BY 'homer';
GRANT ALL PRIVILEGES ON homer.* TO 'homer'@'%';
FLUSH PRIVILEGES;
